...
/*  */
typedef struct _PIDDB_INFO
{
	PERESOURCE lock;
	PRTL_AVL_TABLE table;
}PIDDB_INFO, *PPIDDB_INFO;
...
/* 内存匹配 */
PVOID64 search_pattern(PCUCHAR pattern, UCHAR wildcard, ULONG_PTR len, PVOID64 base, ULONG_PTR size, INT index);

/* 节区扫描 */
PVOID64 scan_section(PCCHAR section, PCUCHAR pattern, UCHAR wildcard, ULONG_PTR len, PVOID64 base);
